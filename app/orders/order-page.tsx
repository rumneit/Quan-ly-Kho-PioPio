...
const returnSelect = "id,return_number,order_id,status,subtotal,refund_amount,note,created_at,updated_at,creator:profiles!sales_returns_created_by_fkey(full_name),orders(id,order_number,customer_id,channel,payment_method,created_at,customers(id,customer_number,name,phone),creator:profiles!orders_created_by_fkey(full_name),shipments(status)),sales_return_items(id,product_id,quantity,unit_price,line_total,products(sku,name))";
